$(document).ready(function() {
    ...
    $('#carer_role').change(function() {
        ...
        if (role == "mum" || role == "dad") {
            ...
            $('#baby_dob_label').html("What the Date of Birth of the baby in your care?");
    ...
    $('#formRegister').find('a').click(function() {
        ...
        if(divId=="#forget_pwd")
        {
            ...
            else
            {
                ...
                $("#forgetPwdLabel").html("Please confirm the email you have registered");
            }
        }

        if ($(this).hasClass("btn")) {
            if (($(this).text() == "prev") || (visibleInput.valid() && ($(this).text() == "next"))) {
                //show current # div
                    ...
                    $.ajax({
                        ...
                        success: function(responseData, textStatus, jqXHR) {
                            ...
                            if (result.status == "ERR") {
                             ...
                             var url = "https://assc-klong-gh.azurewebsites.net/api/check_if_survey_done?email="+signUpEmail;
                             $.ajax({
                                type: "get",
                                url: url,
                                contentType: "application/json",
                ...
                $.ajax({
                    ...
                    success: function(responseData, textStatus, jqXHR) {
                            ...
                            if (result.status == "ERR") {
                                ...
                                $("#modal p").html("Please check your inbox for a reset password link.");
                                $('#modal').openModal();
                            }
                        },
                        error: function(jqXHR, textStatus, errorThrown) {
