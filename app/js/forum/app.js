        ...
        $scope.addPost = function() {
            ...
            $http.post(
                ...
                $http.get('https://assc-klong-gh.azurewebsites.net/tables/post').success(function(data) {
                    ...
                    if ($scope.realImage !== null) {
                        var storageurl = "https://ghpostimages.blob.core.windows.net/ghpostimagescontainer/" + posts[0].id + "?sv=2016-05-31&ss=b&srt=sco&sp=rwdlac&se=2018-01-01T00:54:58Z&st=2017-05-28T16:54:58Z&spr=https,http&sig=9rjgcg9DterXKm6vQHiGzCzkKZ4SKtxhIxWaML18%2BBY%3D";
